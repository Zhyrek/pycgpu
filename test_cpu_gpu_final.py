#!/usr/bin/env python
"""Test CPU vs GPU final values after consolidation fix."""
...
print("Testing CPU vs GPU after consolidation fix...")
...
print(f"Difference = {abs(cpu_x_ti - gpu_x_ti):.2e}")

if abs(cpu_x_ti - gpu_x_ti) < 1e-6:
    print("SUCCESS: CPU and GPU match within numerical precision!")
else:
    print("FAILURE: CPU and GPU still diverge significantly")