...
: (
   0
))))) + x12*(x41*(-53520.0 + x39) + x43*(48232.5 - 8.60954*x[2]) + x44*(-76066.1 + 18.6758*x[2]) + x41*x42*(38590.0 - x39) + x43*(x45 + x9)*(8861.88 - 5.28975*x[2]) + x44*(x45 + x8)*(21167.4 + 1.3398*x[2]) + 1170.0*x0*x3*pow(x42, 2)*x[9]) + x17*(-x20*x21 - x23*x20 - x21*x19*x[5] + x5*x18*x[3] + x5*x22*x[5] - x23*x[9]*x[7]*x[4]) + (x46*x18 + x46*x22)*x17 + x14*x17*(x13 + 0.75*((1e-15 < x[3]) ? (
   x[3]*log(x[3])
)
: (
   0
...
: (
   0
)))) + x13*(x42*(-53520.0 + x40) + x44*(48232.5 - 8.60954*x[2]) + x45*(-76066.1 + 18.6758*x[2]) + x42*x43*(38590.0 - x40) + x45*(x46 + x9)*(21167.4 + 1.3398*x[2]) + (x10 + x46)*x44*(8861.88 - 5.28975*x[2]) + 1170.0*x1*x4*pow(x43, 2)*x[9]) + x18*(-x22*x21 - x24*x21 - x22*x20*x[5] + x6*x19*x[3] + x6*x23*x[5] - x24*x[9]*x[7]*x[4]) + (x47*x19 + x47*x23)*x18 + x15*x18*(x14 + 0.75*((1e-15 < x[3]) ? (
   x[3]*log(x[3])
)
: (
   0
...
: (
   0
    ...
    out[2] = x228 + x0*(x224 + x124*(x115 + x122 + 0.75*((x90 == 1) ? (
   1 + x89
)
: (
   0
...
: (
   0
    ...
    out[5] = x285 + x0*(x284 + x124*(x117 + x288 + 0.25*((x96 == 1) ? (
   1 + x95
)
: (
   0
...
__device__ void pycgpu_model_12_formulahess(double* out, const double* x) {
    ...
    double x35 = 1.0*x2;
    double x36 = 0.75*x[4] + 0.25*x[7];
    double x37 = 1.0*x36;
    double x38 = 0.75*x[3];
    double x39 = 0.25*x[6] + x38;
    double x40 = 1.0*x39;
    double x41 = x35 + x37 + x40;
    double x42 = pow(x41, -1);
    double x43 = 2.1*x3;
    double x44 = -x43 <= 0;
    double x45 = ((x44 == 1) ? (
...
: 0)));
    ...
    double x157 = x35*x154 + x37*x152 + x40*x156;
...
: 0));
    ...
    double x725 = -x2*x510 - x36*x508 + x427*x724 + x724*x203;
    ...
    double x731 = x37*x39;
    double x732 = x36*x39;
    double x733 = x35*x695 + x36*x524 + x39*x525 + x470*x731 + x482*x731 + x732*x522 + x36*x35*x527;
    ...
    double x739 = x35*x153 + x37*x151 + x40*x155;
    double x740 = x732*x163;
    double x741 = 1755.0*x740;
    double x742 = 0.75*x36;
    ...
    double x749 = x542 + x121*(x461 + x571 + x739) + x121*(x741 + x744 + x745 + 0.75*x746 + x2*x473 + x36*x475 + x36*x483 + x470*x742) - x432*x449 + x52*(x441*x728 + x724*x138) - (x454 + x748)*x121;
    ...
    double x761 = x591 + x121*(x523*x564 + x527*x564 - x620*x526 + x36*x526*x564) + (x623 + x760)*x121 - (-x757 + x759)*x121 + (-x501*x[7] - x501*x[8])*x52;
    ...
    double x862 = x134 + x735 + x792 + x121*(x603 + x623 + x860) + x414*x330 + x429*x302 - x449*x244 + x52*(x781 + 6.0*x600*x[3] + x724*x194 - x861*x[7] - x861*x[8]) + x788*(-x295 + x787 + x859) - (x608 - x609 + x748 + x780)*x121 + (-x744 - x782 + x36*x579 + x39*x473 + x464*x476 + x742*x527)*x121 - x413*x823*x297;
    ...
    double x922 = 0.25*x36;
    double x923 = 0.25*x743;
    double x924 = x644*x568;
    double x925 = 3.0*x747;
    double x926 = x866 + x121*(x656 + x739 + x763) + x121*(x648 + 0.25*x746 + x921 + x923 + x924 + x2*x642 + x36*x643 + x470*x922) - x432*x653 + x52*x920 - (x654 + x925)*x121;
    ...
    double x940 = x904 + x121*(-x2*x937 + x36*x937 + x903*x523 + x903*x527) + (x670 + x712)*x121 - (-x934 + x938)*x121 + (-x939*x[4] - x939*x[5])*x52;
...
: 0)));
    ...
    out[18] = x596 + x756 + x0*(x540 + x121*(1.5*x152 + x157) + x121*(x486 - 2632.5*x672 + x3*x758 - x487*x247) + x42*x757 - x439*x254 - x446*x576 - x456*x584 + x456*x588 - x456*x590 + x489*(x253 + 0.75*((x63 == 1) ? (
   pow(x[4], -1)
)
: 0)));
...
__device__ PhaseRecord g_phase_records_array[14]; // Must be at least 1
    ...
    if (tid < num_conditions_total && results_list_ptr_raw != nullptr) {
        ...
        if (initial_data_byte_array != nullptr && condition_idx < num_conditions_total) {
            ...
            for (int ph_idx = 0; ph_idx < safe_num_phases; ++ph_idx) {
                ...
                // Validate phase data
                bool phase_valid = (phase_amount > 1e-12 && phase_record_idx >= 0 && phase_record_idx < 14);
            ...
            device_phase_data.num_unique_phase_records = 14;
