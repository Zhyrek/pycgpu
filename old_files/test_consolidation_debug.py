#!/usr/bin/env python
"""
Test to debug consolidation logic for multi-condition GPU calculations.
"""
...
def main():
    ...
    # Test 2: Multiple temperatures with verbose output
    print("\nMultiple temperatures with verbose GPU output:")
