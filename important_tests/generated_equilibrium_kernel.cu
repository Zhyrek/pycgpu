...
: (
   0
    ...
    out[1] = x87 + x0*(x84 + x1*(x62 + x66 + x59*x17) + x52*(x48 + x67 + 0.6275*((x33 == 1) ? (
   1 + x32
)
: (
   0
))) - x70*x29);
    out[2] = x87 + x0*(x84 + x1*(x66 + x74*x17 + x76*x[5]) + x52*(x49 + x67 + 0.6275*((x35 == 1) ? (
   1 + x34
)
: (
   0
...
: (
   0
    ...
    out[1] = x52 + x0*(x59 + x38*(x34 + x35 + 2.0*((x26 == 1) ? (
   1 + x25
)
: (
   0
))) - x39*x19 + (x47 + x54)*x1);
    out[2] = x52 + x0*(x59 + x38*(x34 + x36 + 2.0*((x28 == 1) ? (
   1 + x27
)
: (
   0
...
: (
   0
    ...
    out[1] = x59 + x0*(x56 + x38*(x34 + x35 + 5.0*((x26 == 1) ? (
   1 + x25
)
: (
   0
))) - x39*x19 + (x46 + x48)*x1);
    out[2] = x59 + x0*(x56 + x1*(x48 + x49*x[5]) + x38*(x37 + 5.0*((x28 == 1) ? (
   1 + x27
)
: (
   0
...
: (
   0
    ...
    out[2] = x75 + x2*(x73 + x3*(x62 + x68 + x69*x[5]) + x41*(x34 + x76 + 1.0*((x35 == 1) ? (
   1 + x44
)
: (
   0
))) + x72*x48);
    out[3] = x75 + x2*(x77 + x3*(x62 + x66 + x70) + x41*(x36 + x76 + 1.0*((x33 == 1) ? (
   1 + x45
)
: (
   0
))));
    out[4] = x75 + x2*(x77 + x3*(x62 + x55*x[3] + x67*x[4]) + x41*(x32 + x34 + x36 + 1.0*((x37 == 1) ? (
   1 + x43
)
: (
   0
...
: (
   0
    ...
    double x40 = 1.0*((x35 == 1) ? (
   0
)
: (
   0
));
    double x41 = 1.0*((x33 == 1) ? (
   0
)
: (
   0
...
: (
   0
    ...
    out[2] = x69 + x0*(x68 + x44*(x43 + 1.0*((x31 == 1) ? (
   1 + x30
)
: (
   0
))) + x65*x24 + (x51 + x64)*x27);
    out[3] = x69 + x0*(x68 + x44*(x40 + x70 + 1.0*((x33 == 1) ? (
   1 + x32
)
: (
   0
))) + x65*x25 + (x54 + x64)*x27);
    out[4] = x69 + x0*(x68 + x27*(x64 + x55*x[3]) + x44*(x41 + x70 + 1.0*((x35 == 1) ? (
   1 + x34
)
: (
   0
...
: 0))) - x118*x117 + x15*x113 - 8844.0*x34*x112 + x99*x100 - x[2]*x39*x114;
    ...
    out[12] = x164 + x166 + x10*(x142 + x165 + x11*(x72 + x127*x[3]) + x13*(x81 + 1.0*((x2 == 1) ? (
   pow(x[4], -1)
)
: 0)));
...
: 0)) + (2*x67 + x72)*x11);
    ...
    out[24] = x175 + x180 + x10*(x155 + x165 + x13*(x95 + 1.0*((x6 == 1) ? (
   pow(x[6], -1)
)
: 0)) + (2*x71 + x72)*x11);
}
...
: (
   0
    ...
    double x112 = log(x[3]);
    double x113 = 1e-15 < x[3];
    double x114 = log(x[5]);
    double x115 = 1e-15 < x[5];
...
: (
   0
    ...
    out[1] = x262 + x0*(x259 + x108*(-x152 - x153*x[11] + x156*x[10]) + x108*(x146*x[8] + x148*x[8] + x149*x150) + x143*(x138 + x144 + 0.5*((x113 == 1) ? (
   1 + x112
)
: (
   0
...
: (
   0
    ...
    out[3] = x262 + x0*(x281 + x108*(x239 + 54.1229146*x242*x[7] + x273*x150) + x143*(x139 + x144 + 0.5*((x115 == 1) ? (
   1 + x114
)
: (
   0
...
: 0))));
    ...
    double x150 = x1*x[11];
    double x151 = log(x[3]);
    double x152 = x11 + x13 + x17 + x19 + x3 + x5 + x7;
...
: 0))));
    ...
    double x320 = x13 + x15 + x17 + x3 + x5 + x7 + x9;
    double x321 = x19 + x320;
    double x322 = x321 + 0.5*((x10 == 1) ? (
   1 + x272
)
: 0);
...
: 0)) - x398*x305 - x406*x566 + x741*x[7]);
    ...
    out[33] = x645 + x789 + x0*(x805 + x145*(x321 + 0.5*((x10 == 1) ? (
   pow(x[5], -1)
)
...
: (
   0
)))) + x12*(x41*(-53520.0 + x39) + x43*(48232.5 - 8.60954*x[2]) + x44*(-76066.1 + 18.6758*x[2]) + x41*x42*(38590.0 - x39) + x43*(x45 + x9)*(8861.88 - 5.28975*x[2]) + (x10 + x45)*x44*(21167.4 + 1.3398*x[2]) + 1170.0*x0*x3*pow(x42, 2)*x[9]) + x17*(-x20*x21 - x23*x20 - x21*x19*x[5] + x5*x18*x[3] + x5*x22*x[5] - x23*x[9]*x[7]*x[4]) + (x46*x18 + x46*x22)*x17 + x14*x17*(x13 + 0.75*((1e-15 < x[3]) ? (
   x[3]*log(x[3])
)
: (
   0
...
: (
   0
)))) + x13*(x42*(-53520.0 + x40) + x44*(48232.5 - 8.60954*x[2]) + x45*(-76066.1 + 18.6758*x[2]) + x42*x43*(38590.0 - x40) + (x10 + x46)*x44*(8861.88 - 5.28975*x[2]) + (x11 + x46)*x45*(21167.4 + 1.3398*x[2]) + 1170.0*x1*x4*pow(x43, 2)*x[9]) + x18*(-x22*x21 - x24*x21 - x22*x20*x[5] + x6*x19*x[3] + x6*x23*x[5] - x24*x[9]*x[7]*x[4]) + (x47*x19 + x47*x23)*x18 + x15*x18*(x14 + 0.75*((1e-15 < x[3]) ? (
   x[3]*log(x[3])
)
: (
   0
...
: (
   0
    ...
    double x87 = log(x[3]);
    double x88 = 1e-15 < x[3];
    double x89 = log(x[7]);
    double x90 = 1e-15 < x[7];
    double x91 = log(x[8]);
    double x92 = 1e-15 < x[8];
    double x93 = log(x[4]);
    double x94 = 1e-15 < x[4];
    double x95 = log(x[5]);
    double x96 = 1e-15 < x[5];
    double x97 = log(x[6]);
...
: (
   0
    ...
    double x115 = 0.25*((x92 == 1) ? (
   0
)
: (
   0
));
    double x116 = 0.75*((x94 == 1) ? (
   0
)
: (
   0
...
: (
   0
    ...
    double x119 = 0.75*((x96 == 1) ? (
   0
)
: (
   0
));
    double x120 = 0.25*((x90 == 1) ? (
   0
)
: (
   0
));
    double x121 = 0.75*((x88 == 1) ? (
   0
)
: (
   0
...
: (
   0
    ...
    double x175 = x115 + x116 + x117 + x118 + x120;
...
: (
   0
    ...
    double x288 = x115 + x116 + x118 + x119 + x121;
...
: (
   0
    ...
    out[1] = x228 + x0*(x224 + x124*(x119 + x175 + 0.75*((x88 == 1) ? (
   1 + x87
)
: (
   0
    ...
    out[2] = x228 + x0*(x224 + x124*(x115 + x122 + 0.75*((x94 == 1) ? (
   1 + x93
)
: (
   0
...
: (
   0
    ...
    out[5] = x285 + x0*(x284 + x124*(x117 + x288 + 0.25*((x90 == 1) ? (
   1 + x89
)
: (
   0
...
__device__ void pycgpu_model_7_formulahess(double* out, const double* x) {
    ...
    double x35 = 0.75*x[3];
    double x36 = 0.25*x[6] + x35;
    double x37 = 1.0*x36;
    double x38 = 0.75*x[4] + 0.25*x[7];
    double x39 = 1.0*x38;
    double x40 = 1.0*x2;
    double x41 = x37 + x39 + x40;
    double x42 = pow(x41, -1);
    double x43 = 2.1*x3;
    double x44 = -x43 <= 0;
    double x45 = ((x44 == 1) ? (
...
: 0);
    double x59 = 1e-15 < x[5];
    double x60 = 0.75*((x59 == 1) ? 0
: 0);
    double x61 = 1e-15 < x[4];
    double x62 = 0.75*((x61 == 1) ? 0
: 0);
    double x63 = 1e-15 < x[8];
    double x64 = 0.25*((x63 == 1) ? 0
: 0);
    double x65 = 1e-15 < x[3];
...
: 0)));
    ...
    double x157 = x37*x156 + x39*x152 + x40*x154;
...
: 0))));
    ...
    double x201 = pow(x36, 2);
    double x202 = 14.9556222*x3;
    double x203 = x36*x122;
...
: 0));
    double x218 = x39*x217;
    double x219 = x37*x149;
...
: 0);
    ...
    double x252 = x54 + x56 + x58 + x60 + x66;
    double x253 = x252 + x64;
    double x254 = x253 + 0.75*((x61 == 1) ? (
   1 + x232
)
: 0);
...
: 0))));
    ...
    double x332 = x[9]*x[6];
    double x333 = x54 + x58 + x62 + x64 + x66;
    double x334 = x333 + x56;
    double x335 = x334 + 0.75*((x59 == 1) ? (
   1 + x233
)
: 0);
...
: 0);
    ...
    double x383 = x252 + x62;
    double x384 = x383 + 0.25*((x63 == 1) ? (
   1 + x231
)
: 0);
...
: 0))));
    ...
    double x415 = 2.0*x38;
    double x416 = x36*x415;
    double x417 = x2*x36;
    double x418 = x42*x417;
    double x419 = x333 + x60;
...
: 0));
    ...
    double x566 = x36*x469;
    double x567 = x474*x[9];
    double x568 = x38*x469;
    ...
    double x624 = x593 - 3.375*x621 + x121*(-x463*x620 + x464*x564 + x472*x564 + x36*x463*x564) + (x443 + x612)*x52 - (x448 + x622)*x121 + (x571 + x623)*x121;
    ...
    double x695 = x36*x472;
    double x696 = x38*x685;
    ...
    double x725 = -x2*x510 - x38*x508 + x427*x724 + x724*x203;
    ...
    double x731 = x36*x39;
    double x732 = x36*x38;
    double x733 = x36*x525 + x38*x524 + x40*x695 + x470*x731 + x482*x731 + x732*x522 + x40*x38*x527;
    ...
    double x739 = x37*x155 + x39*x151 + x40*x153;
    double x740 = x732*x163;
    double x741 = 1755.0*x740;
    double x742 = 0.75*x38;
    ...
    double x749 = x542 + x121*(x461 + x571 + x739) + x121*(x741 + x744 + x745 + 0.75*x746 + x2*x473 + x38*x475 + x38*x483 + x470*x742) - x432*x449 + x52*(x441*x728 + x724*x138) - (x454 + x748)*x121;
    ...
    double x761 = x591 + x121*(x523*x564 + x527*x564 - x620*x526 + x38*x526*x564) + (x623 + x760)*x121 - (-x757 + x759)*x121 + (-x501*x[7] - x501*x[8])*x52;
    ...
    double x783 = x2*x527;
    double x784 = x121*(x589 + x739 + x760) + x121*(x583 - x741 - x745 + x782 + 0.75*x783 + x2*x579 + x36*x475 + x476*x470) + x52*(x781 - x726*x[7] - x726*x[8]) - (-x587 + x780)*x121;
    ...
    double x862 = x134 + x735 + x792 + x121*(x603 + x623 + x860) + x414*x330 + x429*x302 - x449*x244 + x52*(x781 + 6.0*x600*x[3] + x724*x194 - x861*x[7] - x861*x[8]) + x788*(-x295 + x787 + x859) - (x608 - x609 + x748 + x780)*x121 + (-x744 - x782 + x36*x473 + x38*x579 + x464*x476 + x742*x527)*x121 - x413*x823*x297;
    ...
    double x912 = x180 + x890 - x35*x905 - x363*x384 - x401*x362 - x404*x910 - x697*x359 - x701*x360 - x703*x359 + x706*x359 + x911*x183;
    double x913 = x710 + x912;
    double x914 = x463*x903;
    double x915 = x440*x578;
    double x916 = -0.375*x621 + x907 - x121*(0.75*x447 + x915) + x121*(-x2*x914 + x36*x914 + x472*x903 + x914*x166) + (x712 + x763)*x121;
    double x917 = 0.25*x719 + x896 + x35*x899 + x401*x872 - x42*x911 + x697*x863 + x703*x863 - x706*x863 + x720*x364 + x874*x384;
    ...
    double x922 = 0.25*x38;
    double x923 = 0.25*x743;
    double x924 = x644*x568;
    double x925 = 3.0*x747;
    double x926 = x866 + x121*(x656 + x739 + x763) + x121*(x648 + 0.25*x746 + x921 + x923 + x924 + x2*x642 + x38*x643 + x470*x922) - x432*x653 + x52*x920 - (x654 + x925)*x121;
    ...
    double x940 = x904 + x121*(-x2*x937 + x38*x937 + x903*x523 + x903*x527) + (x670 + x712)*x121 - (-x934 + x938)*x121 + (-x939*x[4] - x939*x[5])*x52;
    double x941 = 0.25*x581;
    double x942 = -x727;
    double x943 = -x678;
    double x944 = x121*(x670 + x676 + x739) + x121*(x687 + 0.25*x783 - x921 - x924 + x941 + x2*x685 + x36*x643 + x470*x644) + x52*(-x498 - x504 + x942) - (-x680 + x943)*x121;
    ...
    double x960 = x134 + x918 + x949 + x121*(x702 + x712 + x860) + x121*(x696 - x923 - x941 + x36*x642 + x464*x644 + x922*x527) + x405*x429 - x413*x837 + x413*x838 - x653*x244 + x788*(-x403 + x859 + x945) + (-x699 - x700 + x920 + x942)*x52 - (x704 - x705 + x925 + x943)*x121;
    ...
    out[0] = x0*(34.9209*x107 + 16.629*x108 + x137 + 16.629*x69 + x121*(x37*x[9]*((x113 == 1) ? (
...
: 0)))));
    out[7] = (x431 + x434)*x0;
    out[8] = x241 + x438;
    out[9] = x553 + x563 + x0*(x540 + x121*(1.5*x156 + x157) + x121*(2632.5*x479 + x486 + x3*x488 + x487*x161) - x42*x448 - x439*x174 - x445*x446 + x448*x183 - x451*x[8] + x455*x456 - x456*x462 - x456*x484 + x489*(x173 + 0.75*((x65 == 1) ? (
   pow(x[3], -1)
)
: 0)));
    ...
    out[18] = x596 + x756 + x0*(x540 + x121*(1.5*x152 + x157) + x121*(x486 - 2632.5*x672 + x3*x758 - x487*x247) + x42*x757 - x439*x254 - x446*x576 - x456*x584 + x456*x588 - x456*x590 + x489*(x253 + 0.75*((x61 == 1) ? (
   pow(x[4], -1)
)
: 0)));
...
: 0)))));
    ...
    out[27] = x628 + x794 + x0*(x538 + x121*(1.5*x154 + x157) - 12.47175*x297*x227 - x439*x335 - x446*x613 - x450*x332 - x456*x604 - x456*x607 + x456*x610 + x489*(x334 + 0.75*((x59 == 1) ? (
   pow(x[5], -1)
)
...
: 0)))));
    ...
    out[54] = x917 + x952 + x0*(-4.15725*x707 + x890 - x906 + x121*(0.5*x154 + x157) + 16.629*x401*x720 - pow(x404, 2)*x823 - 4.15725*x408*x226 + x489*(x383 + 0.25*((x63 == 1) ? (
   pow(x[8], -1)
)
: 0)) + x51*((x17 == 1) ? (
...
: 0))) + 10.0*x0*x2*x4*x[4]);
    ...
    out[3] = x102 + x113;
    out[4] = x100 + x101;
    out[5] = x182 + x120*x121 + x16*x122 + x2*x153 + x35*(x181 - x120*x161 - x122*x160 + x14*(x56 + 1.0*((x9 == 1) ? (
   pow(x[3], -1)
)
: 0)) + x34*(2*x142 + x147 + x156 + 2*x157 - x159 + x154*x[5] - 11248.0*x3*x[4] + (4.0/3.0)*x37*x133) - x84*x153 + (2*x73 + x74)*x34);
    ...
    out[8] = x101 + x109;
    out[9] = x201;
    out[10] = x182 + x121*x196 + x121*x197 + x16*x189 + x35*(x181 + x14*(x106 + 1.0*((x7 == 1) ? (
   pow(x[4], -1)
)
...
__device__ PhaseRecord g_phase_records_array[9]; // Must be at least 1
...
__global__ void init_all_gpu_phase_records() {
    ...
    g_phase_records_array[3].init(&pycgpu_model_3_obj, &pycgpu_model_3_formulaobj, &pycgpu_model_3_formulagrad, &pycgpu_model_3_formulahess, &pycgpu_model_3_internal_cons_func, &pycgpu_model_3_internal_cons_jac, &pycgpu_model_3_mass_obj, &pycgpu_model_3_formulamole_obj, &pycgpu_model_3_formulamole_grad, 3, 4, 4, 2, 3);
    g_phase_records_array[4].init(&pycgpu_model_4_obj, &pycgpu_model_4_formulaobj, &pycgpu_model_4_formulagrad, &pycgpu_model_4_formulahess, &pycgpu_model_4_internal_cons_func, &pycgpu_model_4_internal_cons_jac, &pycgpu_model_4_mass_obj, &pycgpu_model_4_formulamole_obj, &pycgpu_model_4_formulamole_grad, 3, 4, 4, 2, 3);
    g_phase_records_array[5].init(&pycgpu_model_5_obj, &pycgpu_model_5_formulaobj, &pycgpu_model_5_formulagrad, &pycgpu_model_5_formulahess, &pycgpu_model_5_internal_cons_func, &pycgpu_model_5_internal_cons_jac, &pycgpu_model_5_mass_obj, &pycgpu_model_5_formulamole_obj, &pycgpu_model_5_formulamole_grad, 3, 9, 4, 3, 3);
    g_phase_records_array[6].init(&pycgpu_model_6_obj, &pycgpu_model_6_formulaobj, &pycgpu_model_6_formulagrad, &pycgpu_model_6_formulahess, &pycgpu_model_6_internal_cons_func, &pycgpu_model_6_internal_cons_jac, &pycgpu_model_6_mass_obj, &pycgpu_model_6_formulamole_obj, &pycgpu_model_6_formulamole_grad, 3, 5, 4, 3, 3);
    g_phase_records_array[7].init(&pycgpu_model_7_obj, &pycgpu_model_7_formulaobj, &pycgpu_model_7_formulagrad, &pycgpu_model_7_formulahess, &pycgpu_model_7_internal_cons_func, &pycgpu_model_7_internal_cons_jac, &pycgpu_model_7_mass_obj, &pycgpu_model_7_formulamole_obj, &pycgpu_model_7_formulamole_grad, 3, 7, 4, 3, 3);
    g_phase_records_array[8].init(&pycgpu_model_8_obj, &pycgpu_model_8_formulaobj, &pycgpu_model_8_formulagrad, &pycgpu_model_8_formulahess, &pycgpu_model_8_internal_cons_func, &pycgpu_model_8_internal_cons_jac, &pycgpu_model_8_mass_obj, &pycgpu_model_8_formulamole_obj, &pycgpu_model_8_formulamole_grad, 3, 3, 4, 1, 3);
    ...
    if (tid < num_conditions_total && results_list_ptr_raw != nullptr) {
        ...
        if (initial_data_byte_array != nullptr && condition_idx < num_conditions_total) {
            ...
            for (int ph_idx = 0; ph_idx < safe_num_phases; ++ph_idx) {
                ...
                // Validate phase data
                bool phase_valid = (phase_amount > 1e-12 && phase_record_idx >= 0 && phase_record_idx < 9);
            ...
            device_phase_data.num_unique_phase_records = 9;
