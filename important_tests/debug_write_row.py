#!/usr/bin/env python
"""Debug write_row_fixed_mole_fraction inputs."""
...
def main():
    ...
    print("=" * 80)
    print("DEBUG write_row_fixed_mole_fraction INPUTS")
    print("=" * 80)
    
    print("\nCPU calculation (first iteration only)...")
    # Patch the CPU code to print more debug info
    import pycalphad.core.minimizer as cpu_min
    
    # Run CPU to see what it's doing
