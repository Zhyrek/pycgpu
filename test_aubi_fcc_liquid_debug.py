#!/usr/bin/env python
"""Debug specific conditions for FCC_A1 + LIQUID phases in Au-Bi system."""
...
def main():
    ...
    print("Testing Au-Bi system with FCC_A1 + LIQUID phases")
    print("FCC_A1 has vacancy sublattice: (AU,BI)(VA)")
    
    # Test specific problematic conditions
    test_conditions = [
        (0.1, 400),  # Low T, Au-rich - the one that showed issues
    ]
